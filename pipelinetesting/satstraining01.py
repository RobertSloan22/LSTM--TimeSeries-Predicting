...
def load_model_and_predict():
    ...
    model = load_model('modelsats4.h5')
...
def index():
    ...
    return render_template('satsdash.html', logs=parsed_logs, plot_url=plot_path, dates=json.dumps(list(dates)), predictions=json.dumps(predictions.tolist()))
