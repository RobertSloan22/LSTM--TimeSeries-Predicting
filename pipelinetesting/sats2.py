...
import json
import time
from tensorflow.keras.losses import MeanSquaredError  # Import custom objects if any
import dash
...
def load_model_and_predict():
    ...
    model = load_model('model2.h5', custom_objects={'mse': MeanSquaredError()})
...
def index():
    ...
    return render_template('model.html', logs=parsed_logs, plot_url=plot_path, dates=json.dumps(list(dates)), predictions=json.dumps(predictions.tolist()))
