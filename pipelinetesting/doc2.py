...
def train_model():
    ...
    for _ in range(num_predictions):
        ...
        current_sequence[0, -1, features.columns.get_loc('price_sats')] = prediction
...
if __name__ == "__main__":
    ...
    server_thread = Thread(target=socketio.run, args=(app,), kwargs={'host': '0.0.0.0', 'port': 4400, 'debug': False})
    server_thread.start()
